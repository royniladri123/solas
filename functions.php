	...
	function twentynineteen_setup() {
		...
		register_nav_menus(
			array(
				...
				'footer2' => __( 'Second Footer Menu', 'twentynineteen' ),
				'footer3' => __( 'Third Footer Menu', 'twentynineteen' ),
			)
		);
...
function mytheme()
{
	...
	wp_enqueue_script('jquery-min-js', get_template_directory_uri().'/js/jquery-3.5.1.min.js',array(),1.0,true);
	wp_enqueue_script('bootstrap-bundle-min-js', get_template_directory_uri().'/js/bootstrap.bundle.min.js',array(),1.0,true);
	wp_enqueue_script('slick-min-js', get_template_directory_uri().'/js/slick.min.js',array(),1.0,true);
	wp_enqueue_script('common-js', get_template_directory_uri().'/js/common.js',array(),1.0,true);
}
